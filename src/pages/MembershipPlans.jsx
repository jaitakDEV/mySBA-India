...
//   return (
//     <div className="group relative flex flex-col overflow-hidden rounded-[32px] bg-white/90 backdrop-blur-xl border border-white/60 shadow-[0_10px_40px_rgba(0,0,0,0.05)] hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(255,122,0,0.12)] transition-all duration-300">
//       {/* HEADER */}
...
//         {/* BUTTON */}
//         <button className="mt-8 w-full py-4 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-400 text-white font-semibold flex items-center justify-center gap-3 shadow-[0_10px_35px_rgba(255,122,0,0.18)] hover:opacity-95 transition-all">
//           Buy Plan
